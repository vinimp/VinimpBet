...
class BetsControllerTest < ActionController::TestCase
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post :create, bet: { data: @bet.data, evento: @bet.evento, pareggio: @bet.pareggio, sconfitta: @bet.sconfitta, vittoria: @bet.vittoria }
    end
  ...
  test "should update bet" do
    patch :update, id: @bet, bet: { data: @bet.data, evento: @bet.evento, pareggio: @bet.pareggio, sconfitta: @bet.sconfitta, vittoria: @bet.vittoria }
    assert_redirected_to bet_path(assigns(:bet))
  end
